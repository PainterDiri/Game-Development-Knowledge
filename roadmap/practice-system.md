...
> **2026-08 优化版**：课程实践现在按“主项目接缝 + 独立验证载体 + 可下载实践代码”组织。不是把所有课程强行改成 Unity 作业，而是让经过验证的结果逐步汇入同一个小以撒纵切片。详见[共享项目契约](roguelite-project-contract.md)和[实践包与下载](practice-bundles.md)。
